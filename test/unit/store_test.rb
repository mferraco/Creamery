  ...
  context "Creating three stores" do
    ...
    should "shows that there is one inactive store" do
     ...
     should "get the the right coordinates for a store" do
        assert_equal 40.4435037, @cmu.latitude
        assert_equal (-79.9415706), @cmu.longitude
     end
     
     should "create a map link" do
       assert_equal @cmu.create_map_link, "http://maps.google.com/maps/api/staticmap?center=40.4435037,-79.9415706&zoom=15&size=800x450&maptype=roadmap&markers=color:red%7Ccolor:red%7Clabel:%7C40.4435037,-79.9415706&sensor=false"
     end
  end
end
