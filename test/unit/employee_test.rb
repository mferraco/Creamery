...
class EmployeeTest < ActiveSupport::TestCase
  ...
  context "Creating six employees of three levels" do
    ...
    # test the get_last_shift method
    should "return the last shift for the employee" do
      @shift1 = FactoryGirl.create(:shift, :assignment => @assign_cindy, :date => 2.days.ago)
      
      assert_equal @shift1.date.to_date, @cindy.get_last_shift
      assert_equal nil, @ben.get_last_shift
